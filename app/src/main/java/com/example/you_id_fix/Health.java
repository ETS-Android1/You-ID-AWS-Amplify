...
public class Health extends AppCompatActivity implements AdapterView.OnItemSelectedListener, Serializable {
    private static final String TAG = "Permissions";
    String userID;
    String displayEmail;
    ListView listHealthContacts;
    ImageView imgView;
    Button editImages;
    String fullName;
    String email;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addContactIcon = findViewById(R.id.imageViewAddContact);
        imgView = findViewById(R.id.healthImageView);
        displayEmail = Amplify.Auth.getCurrentUser().getUsername();
        userID = Amplify.Auth.getCurrentUser().getUserId();
        imageVBack = findViewById(R.id.returnToMainFromHealth);
        editImages = findViewById(R.id.btn_editHealthImages);
        navView = findViewById(R.id.nav_view_health);
        drawer = findViewById(R.id.drawerLayoutHealth);
        healthSpinner = findViewById(R.id.dropDownHealthDocuments);
        healthSpinner.setOnItemSelectedListener(this);

        navView.setCheckedItem(R.id.navHealth);
        navView.setNavigationItemSelectedListener(item -> {
            ...
            DrawerLayout drawer = findViewById(R.id.drawerLayoutHealth);
        ...
        Amplify.DataStore.query(
                Contacts.class,
                Where.matches(Contacts.USER_ID.eq(userID).and(Contacts.TYPE.eq("Health"))),
                Contacts -> {
        ...
        listHealthContacts = findViewById(R.id.listViewHealthContacts);
        ...
        listHealthContacts.setAdapter(adapter);


        addContactIcon.setOnClickListener( v -> {
        ...
        listHealthContacts.setOnItemClickListener((parent, view, position, id) -> {
