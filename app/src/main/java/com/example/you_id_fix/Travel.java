...
public class Travel extends AppCompatActivity implements AdapterView.OnItemSelectedListener, Serializable {
    String userID, displayEmail;
    ListView listTravelContacts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageVBack = findViewById(R.id.returnToMainFromTravel);
        editImages = findViewById(R.id.btn_editTravelImages);
        imgView = findViewById(R.id.travelImageView);
        navView = findViewById(R.id.nav_view_travel);
        drawer = findViewById(R.id.drawerLayoutTravel);
        travelSpinner = findViewById(R.id.dropDownTravelDocuments);
        travelSpinner.setOnItemSelectedListener(this);

        navView.setCheckedItem(R.id.navTravel);
        navView.setNavigationItemSelectedListener(item -> {
            ...
            DrawerLayout drawer = findViewById(R.id.drawerLayoutTravel);
        ...
        Amplify.DataStore.query(
                Contacts.class,
                Where.matches(Contacts.USER_ID.eq(userID).and(Contacts.TYPE.eq("Travel"))),
                Contacts -> {
        ...
        listTravelContacts = findViewById(R.id.listViewTravelContacts);
        ...
        listTravelContacts.setAdapter(adapter);
        ...
        listTravelContacts.setOnItemClickListener((parent, view, position, id) -> {
